...
``` {r}
years <- a %>%
gather(year, pop, X1790:X1800:X1810:X1820:X1840:X1850:X1860:X1870:X1880:X1890:X1900:X1910:X1920:X1940:X1950:X1960:X1970:X1980:X1990:X2000:X2010) %>%
mutate(year = gsub("X", "", year) + 0)
...
``` {r}
write.csv(years, file='data/years')
```
